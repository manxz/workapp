 ...
 * 
 * Design matches Figma modal specifications.
 */
          ...
          <div className="flex-1 flex flex-col justify-between h-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`text-white text-xs font-medium px-3 py-1.5 rounded-[7px] transition-colors ${
                  confirmVariant === "danger"
                    ? "bg-red-600 border border-red-700 hover:bg-red-700"
                    : "bg-[#1d1d1f] border border-black hover:bg-[#3d3d3f]"
                }`}
              >
                {confirmLabel}
              </button>
